...
export default function FloorPlan() {
    ...
    "1RK": [
      {
        ...
        image:
          "https://img.freepik.com/free-vector/silhouette-skyline-illustration_53876-78786.jpg",
      },
    ],
    "1BHK": [
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      <h1
        id="PricePlans"
        className="text-3xl font-extrabold mb-6 text-center md:text-left"
      >
      ...
      <div className="flex flex-wrap gap-2 justify-center md:justify-start mb-4">
        <button
          className={`px-4 py-2 rounded-md border cursor-pointer ${
            selectedPlan === "1RK" ? "bg-purple-500 text-white" : "bg-gray-800"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded-md border cursor-pointer ${
            selectedPlan === "1BHK" ? "bg-purple-500 text-white" : "bg-gray-800"
          }`}
      ...
      <div className="flex overflow-x-auto gap-2 justify-center md:justify-start mb-4 pl-[100px]">
        {floorPlans[selectedPlan].map((plan, index) => (
          <button
            key={index}
            className={`px-4 py-2 rounded-md border min-w-[110px] text-sm md:text-base 
        transition duration-200 ease-in-out cursor-pointer 
        ${
          selectedImage === plan.image
            ? "bg-purple-500 text-white"
            : "bg-gray-900 hover:bg-purple-400 hover:text-white"
        }`}
      ...
      <div className="border relative rounded-md p-4 shadow-md bg-white flex flex-col items-center">
        ...
        <img
          ...
          className="selectedImg w-full h-96 object-contain mb-4 p-4"
        />
